    ...
    return (
        <>
            <main>
                ...
                <section className="section about-services" data-scroll-section>
                    <div className="container">
                        <div className="row">
                            <div className="flex-col">
                                <h2>
                                    I can help you with <span className="animate-dot">.</span><span className="animate-dot">.</span><span className="animate-dot">.</span>
                                </h2>
                            </div>
                        </div>
                        <div className="row">
                ...
                <section className="section about-awwwards" data-scroll-section>
                    <div className="container medium">
                        <div className="row">
                            <div className="flex-col">
                                <div className="single-image">
                                    <div className="overlay" data-scroll data-scroll-speed="-1"></div>
                                    <div className="overlay"></div>
                                </div>
                            </div>
                            <div className="flex-col">
                                <div className="awwwards-badge">
                                    <svg width="102" height="101" viewBox="0 0 102 101">
                                        <g fill="#999D9E" fillRule="evenodd">
                                            {/* SVG path here */}
                                        </g>
                                    </svg>
                                    <svg width="49" height="30" viewBox="0 0 49 30">
                                        <path d="m37.068.118-4.8 26.632-5.577.734-6.588-15.95-2.236 17.112-5.577.734L.76 4.898l6.34-.835 6.873 16.944 2-18.112 5.883-.774 6.62 16.977L30.729.952l6.339-.834zm11.367 20.48c.32 2.434-1.264 4.499-3.698 4.82-2.434.32-4.5-1.265-4.821-3.699-.32-2.434 1.265-4.5 3.699-4.82 2.434-.32 4.5 1.265 4.82 3.699z" fill="#999D9E" fillRule="evenodd"></path>
                                    </svg>
                                </div>
                ...
                <div className="footer-rounded-div" data-scroll-section>
                        ...
                        <div className="container medium">
                            <div className="row">
                                <div className="flex-col">
                                    ...
                                    <h2><span><div className="profile-picture"></div> Let’s work </span><span>together</span></h2>
                                </div>
                            </div>
                            <div className="row">
                                <div className="flex-col">
                                    ...
                                    <div className="btn-fixed">
                                        <div className="btn btn-round" data-scroll data-scroll-speed="-1" data-scroll-direction="horizontal" data-scroll-position="bottom" data-scroll-offset="-50%, 0">
                                            <a href="https://dennissnellenberg.com/contact" className="btn-click magnetic" data-strength="100" data-strength-text="50">
                            ...
                            <div className="row">
                                <div className="flex-col">
                                    <div className="btn btn-normal">
                                        <a href="mailto:info@dennissnellenberg.com" className="btn-click magnetic" data-strength="25" data-strength-text="15">
                                            <div className="btn-fill"></div>
                                            <span className="btn-text">
                                                <span className="btn-text-inner change">info@dennissnellenberg.com</span>
                                            </span>
                                        </a>
                                    </div>
                                    <div className="btn btn-normal">
                                        <a href="tel:+31627847430" className="btn-click magnetic" data-strength="25" data-strength-text="15">
                                            <div className="btn-fill"></div>
                                            <span className="btn-text">
                                                <span className="btn-text-inner change">+31 6 27847430</span>
                                            </span>
                                        </a>
                                    </div>
                                </div>
